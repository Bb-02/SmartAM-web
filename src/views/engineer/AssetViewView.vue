...
<template>
  <div class="list-page">
    ...
    <div class="search-bar">
      ...
      <el-select v-model="searchForm.category" style="width: 140px" placeholder="全部分类" clearable @change="handleSearch">
...
.header-left h2 { font-size: 22px; font-weight: 700; color: #0f172a; letter-spacing: -0.3px; }
